...
import { MastercardCaseStudyHeroSection } from "./sections/MastercardCaseStudyHeroSection";
...
export const MastercardCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <MastercardCaseStudyHeroSection />
        <BrandVisionSection />
