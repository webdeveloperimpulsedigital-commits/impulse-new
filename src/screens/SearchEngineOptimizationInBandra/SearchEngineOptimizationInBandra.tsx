...
export const SearchEngineOptimizationInBandra = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-bandra"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Bandra" />
        <FooterSection />
      </div>
    </main>
  );
