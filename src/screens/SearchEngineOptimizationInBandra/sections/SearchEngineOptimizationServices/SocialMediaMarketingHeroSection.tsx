...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN BANDRA"];
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="seo agency in bandra; seo company in bandra" />
        ...
        <meta property="og:title" content="SEO Agency in Bandra | SEO Company | Impulse Digital" />
        <meta property="og:description" content="Impulse Digital is an SEO agency in Bandra helping brands grow online through keyword strategy, website optimisation, content planning and performance-led search marketing solutions." />
        ...
        <meta name="twitter:title" content="SEO Agency in Bandra | SEO Company | Impulse Digital" />
        <meta name="twitter:description" content="Impulse Digital is an SEO agency in Bandra helping brands grow online through keyword strategy, website optimisation, content planning and performance-led search marketing solutions." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/bandra/" />
