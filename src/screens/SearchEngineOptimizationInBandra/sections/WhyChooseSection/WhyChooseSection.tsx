...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      title: "Decisions Are Based on Real Data",
      text: "We look at search trends, competitors, and gaps and then build a plan around that.",
    },
    seoStrategies: {
      title: "Every Business Is Treated Differently",
      text: "There’s no fixed template here. What works for one brand might not work for another.",
    },
    transparent: {
      title: "Built Around How People Actually Search",
      text: "Search behaviour keeps changing, and we adjust strategies accordingly instead of sticking to outdated methods.",
    }
  };
