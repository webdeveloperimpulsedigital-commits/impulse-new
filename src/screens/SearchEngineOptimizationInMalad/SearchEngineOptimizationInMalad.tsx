...
export const SearchEngineOptimizationInMalad = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-malad"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Malad" />
        <FooterSection />
      </div>
    </main>
  );
