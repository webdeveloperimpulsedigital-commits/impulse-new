...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    ...
    seoStrategies: {
      ...
      text: "No two businesses are the same, and each comes with its own set of challenges. We adjust the approach based on your goals instead of following a standard template.",
    },
    transparent: {
