...
export const SearchEngineOptimizationInKharghar = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-kharghar"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Kharghar" />
        <FooterSection />
      </div>
    </main>
  );
