  ...
  const data = [
    {
      ...
      points: [
        "Search is gradually evolving, and more people are using AI tools to get quick answers. This changes how content gets picked up and displayed.We make sure your website content is structured in a way that works across both traditional search engines and AI - driven platforms.",
      ],
      img: "/AI SEO.jpg",
    },
    {
      ...
      points: [
        "As websites grow, small issues can start affecting performance, things like indexing gaps or unclear structure.We help clean that up so your website performs more smoothly and doesn’t lose visibility.",
      ],
    ...
    },
    {
      ...
      points: [
        "If your customers are around Kharghar, local searches matter a lot. People nearby are usually closer to taking action. We help your business appear in those searches so you don’t miss out on relevant local inquiries.",
      ],
