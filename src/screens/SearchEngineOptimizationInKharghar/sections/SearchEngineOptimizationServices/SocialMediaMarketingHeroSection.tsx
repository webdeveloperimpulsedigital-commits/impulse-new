...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN KHARGHAR"];
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="seo company in kharghar" />
        ...
        <meta property="og:title" content="SEO Company in Kharghar | SEO Services | Impulse Digital" />
        <meta property="og:description" content="Impulse Digital is an SEO company in Kharghar offering SEO services that help businesses improve rankings, optimise website content and reach customers across search engines." />
        ...
        <meta name="twitter:title" content="SEO Company in Kharghar | SEO Services | Impulse Digital" />
        <meta name="twitter:description" content="Impulse Digital is an SEO company in Kharghar offering SEO services that help businesses improve rankings, optimise website content and reach customers across search engines." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/kharghar/" />
