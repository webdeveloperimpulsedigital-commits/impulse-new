...
export const AmazonEBCaseStudyHeroSection = (): JSX.Element => {
  const heroTextLines = ["Amazon Employer Branding"];

  return (
    <> 
      {/* ✅ SEO Meta Tags */}
    <Helmet>
    <title>Amazon Employer Branding Case Study | Impulse Digital Success Story</title>
    <meta name="description" content="Explore how Impulse Digital executed a powerful Amazon Employer Branding campaign using targeted digital strategies to enhance brand visibility and attract talent." />
    ...
    {/* Open Graph Meta Tags */}
        <meta
          property="og:title"
          content="Amazon Employer Branding Case Study | Impulse Digital Success Story"
        />
        <meta
        ...
        <link rel="canonical" href="https://www.theimpulsedigital.com/casestudies/amazon-eb/" />
