...
export const BrandVisionSection = (): JSX.Element => {
  ...
  return (
    <article className="w-full bg-white" style={{ overflowX: "hidden" }} id="sec-border-uppercase-study-brand-vision">
            ...
            <RevealSection delay={0.05}>
              ...
              >
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, #0f0a2e 0%, #2d1f6e 50%, #543d98 100%)" }}
                >
                  <h2
      ...
      ═══════════════════════════════════════════════ */}
      <RevealSection>
        <div className="relative w-full bg-[#0a071d] flex justify-center group overflow-hidden">
          <video
          ...
          <div
            className="absolute inset-x-0 bottom-0 flex items-end justify-center pb-8 pt-32 pointer-events-none z-20"
