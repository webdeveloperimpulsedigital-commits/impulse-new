export const BrandVisionSection = (): JSX.Element => {
  const stats = [
    {
      percentage: "95%",
      description: "of our clients saw a 50%+ reduction in negative press coverage after implementing crisis communication strategies."
    },
    {
      percentage: "90%", 
      description: "increase in employee satisfaction scores post-communication strategy implementation."
    },
    {
      percentage: "70%",
      description: "increase in stakeholder loyalty due to tailored communication campaigns"
    }
  ];
  ...
  const services = [
    {
      ...
      description: "We assess existing communication channels and define clear objectives."
    },
    {
      title: "Message Framework",
      description: "Core messages and audience maps ensure consistency across touchpoints."
    },
    {
      title: "Execution and Delivery",
      description: "Internal and external communications are managed across media and formats."
    },
    {
      title: "Measurement and Review",
      description: "Performance is tracked through reach, engagement, and sentiment."
    }
  ];
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              <img
                src="/theimpulsedigital.com/rectangle-32.png"
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-[#f8f9fa] rounded-xl p-6 border-l-4 border-[#543d98]">
              <p className="[font-family:'DM_Sans',Helvetica] font-medium text-[#030019] text-base leading-relaxed">
                Every message you send out to your internal or external audience—via your social media channels,
        ...
        <div className="text-center mb-12">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            Emails—says a lot about your company’s philosophy, values, and beliefs. 
            This communication needs to be designed and developed strategically, ensuring that it reaches the intended audience. 
            And who’s this intended audience? Employees, investors, customers, and the world at large. A corporate communication 
            agency is tasked with the responsibility of creating favorable messaging around your brand and leading its reputation.
          </p>
        </div>
