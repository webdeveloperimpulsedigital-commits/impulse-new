      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
           Corporate communication has its own set of unique challenges that hinder its effectiveness. Think about inconsistency 
           in messaging across different channels, disconnected employees, negative press, customer complaints, and poor media 
           networks. A corporate communication agency begins by creating an end-to-end communication strategy, taking into 
           account everyone your company should be communicating
          </p>
        </div>
