...
From Mobile to Desktop
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-3xl md:text-4xl lg:text-5xl mb-8">
           An eCommerce Store That Works Everywhere
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
           Although eCommerce stores are popular and growing in numbers every day, their challenges are equally unique. For one, mobile commerce is at the forefront yet it sees the highest cart abandonment rate of all devices. The best eCommerce SEO services focus on not one but every little aspect of your store, optimizing it for all devices. And an eCommerce SEO agency like ours definitely does more. Think of a store that loads quickly.
          </p>
        </div>
