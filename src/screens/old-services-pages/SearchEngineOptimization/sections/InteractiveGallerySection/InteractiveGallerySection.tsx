      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-3xl md:text-4xl lg:text-5xl mb-8">
            Right Where Your Audience Is Searching 
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            Did you happen to search for “best SEO agencies” or “SEO optimization agency”? If you did, then our SEO efforts are really paying off.
             That’s the beauty of effective SEO—it connects the right audience with your brand. Now, the main point: Like you, 
             millions search this way, making organic search the top method for discovering online content. Now that we have done 
             it for ourselves, this is exactly what we intend to do for your business
          </p>
        </div>
