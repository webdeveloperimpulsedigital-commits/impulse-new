...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/local  After about us section 800 x 530 1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/local  After about us section 800 x 530 2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/local  After about us section 800 x 530 3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            Each and every local business can benefit from Local SEO services. It not only helps your brand or company rank at 
            the top of the ‘near me’ search list but also in organic searches. But there is more to why you should consider 
            investing in it. Local searches are more likely to convert than ‘non-local’ searches. Why? Because they are 
            already interested in what you have to offer. And local customers? They’re more likely to leave positive reviews 
          </p>
        </div>
