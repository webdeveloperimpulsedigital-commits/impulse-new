...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/employee  After about us section 800 x 530 1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/employee  After about us section 800 x 530 2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/employee  After about us section 800 x 530 3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-3xl md:text-4xl lg:text-5xl mb-8">
            Brand Challenges Into Opportunities
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
           The number of challenges to creating a good employer brand is more than you think. Misalignment in values, 
           inconsistent communication, negative reviews online, and lack of internal buy-in can put your company in the 
           spotlight, but not in a good way. Employer branding services target all these challenges individually and cohesively.
            It brings together everyone, from leadership to entry-level employees, manages your reputation
          </p>
        </div>
