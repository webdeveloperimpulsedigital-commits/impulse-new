...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/web After about us section 800 x 530 1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/web After about us section 800 x 530 2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/web  After about us section 800 x 530 3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-3xl md:text-4xl lg:text-5xl mb-8">
            Thinking Meets Always-On Brand Presence
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            The process of website design and development demands a seamless harmony of design thinking, psychology, and user behavior. Every aspect of web design—colors, fonts, flow, content style—shape your brand’s identity and personality. Our web design services ensure that this process is meticulous, highlighting your brand’s unique value proposition and creating a memorable identity so that your brand’s messaging breaks geographical
          </p>
        </div>
