...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/social-media-marketing-after-abou-section1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/social-media-marketing-after-abou-section2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/social-media-marketing-after-abou-section3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            An average internet user spends 151 minutes on social media. That’s enough for us to make sure your brand catches the attention 
            of your audience and drive them to take an action your brand will love. People trust people and by highlighting real experiences 
            and results, we ensure your brand becomes relatable and credible because words alone do no good. We align every element—social proof, 
            user-generated content, educative pieces
          </p>
        </div>
