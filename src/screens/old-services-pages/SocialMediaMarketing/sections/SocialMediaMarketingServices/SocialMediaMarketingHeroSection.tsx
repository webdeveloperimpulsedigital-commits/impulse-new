    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pt-20">
        <div className="text-center flex flex-col items-center">
          <div className="mb-6">
            <h1 className="[font-family:'DM_Sans',Helvetica] font-black text-white text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] leading-[0.9] tracking-tight" style={{ 'textTransform': 'uppercase' as React.CSSProperties['textTransform'] }}>
