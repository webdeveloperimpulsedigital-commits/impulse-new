          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-[#f8f9fa] rounded-xl p-6 border-l-4 border-[#543d98]">
              <p className="[font-family:'DM_Sans',Helvetica] font-medium text-[#030019] text-base leading-relaxed">
                At Impulse Digital, we’re pushing beyond automation, we’re building intelligent systems that act with purpose. Agentic AI is where machines evolve from reactive tools to proactive partners analyzing data, taking contextual decisions, and executing tasks autonomously. Our solutions are designed to make marketing ecosystems smarter, faster, and self-optimizing helping brands save time, improve accuracy, and amplify performance at scale. 
              </p>
            </div>
