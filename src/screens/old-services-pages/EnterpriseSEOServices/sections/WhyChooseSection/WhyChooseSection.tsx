      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <h3 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-2xl md:text-3xl lg:text-4xl">
            Impulse Digital’s Enterprise SEO Services?
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16 lg:mb-20 items-center">
          ...
          <div className="order-1">
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                src="/theimpulsedigital.com/seo why chooose us section 576 x 400 1.jpg"
        ...
        <div className="space-y-8">
          ...
          <div className="w-full">
            <div className="relative overflow-hidden rounded-2xl shadow-lg">
              <img
                src="/theimpulsedigital.com/seo why choose us section 1202 x 400 2.jpg"
          ...
          <div className="max-w-7xl space-y-4">
            ...
            <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#666] text-base leading-relaxed">
              Longer load times and confusing website navigation? That’s a sure shot way to bid goodbye to your visitors. We go beyond keywords, enhancing your site’s speed, responsiveness, and navigation to create a seamless journey for visitors. Result? Longer stay times and engaged visitors who end up taking action. 
