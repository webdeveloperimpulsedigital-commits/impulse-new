export const BrandVisionSection = (): JSX.Element => {
  const stats = [
    {
      percentage: "3X",
      description: "growth in lead generation or conversion through search engine optimization efforts."
    },
    {
      percentage: "50+", 
      description: "global brands enhanced their online visibility with our custom SEO strategies."
    },
    {
      percentage: "97%",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              <img
                src="/theimpulsedigital.com/enterprise About service - 451 x 500.jpg"
        ...
        <div className="text-center mb-12">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            Imagine making sure hundreds, thousands, or even millions (yes, millions) of pages stay up-to-date? This means you need 
            to optimise for different target audiences, languages, regions, and search engines. That’s a lot at once. Mind you, 
            there’s more. You will also have to bring in international SEO. And since it's global, it is not a one department job.
             You will have to coordinate between different teams—marketing, content, IT, and even legal—and align them. Think buy-ins that could take anywhere from weeks to months.
          </p>
        </div>
