...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/enterprise After about us section 800 x 530 1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/enterprise After about us section 800 x 530 2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/enterprise After about us section 800 x 530 3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            Enterprise SEO is evolving day in and day out. While Google is emphasizing content quality, structured data,
             and user experience, you need to focus on personalized, authoritative, and value-centric content. Playing fair 
             is the only way forward and our enterprise seo company is all about that. We go beyond Google’s requirement for E-E-A-T 
             (Experience, Expertise, Authoritativeness, and Trustworthiness) to implement N-E-E-A-T-T. 
          </p>
        </div>
