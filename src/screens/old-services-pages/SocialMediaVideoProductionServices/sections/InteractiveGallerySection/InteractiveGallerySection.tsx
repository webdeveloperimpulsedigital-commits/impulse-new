...
export const InteractiveGallerySection = (): JSX.Element => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/theimpulsedigital.com/video  After about us section 800 x 530 1.jpg",
      // caption: "Brand Strategy",
      alt: "Person working on brand strategy with digital icons and laptop"
    },
    {
      id: 2,
      image: "/theimpulsedigital.com/video  After about us section 800 x 530 2.jpg",
      // caption: "Content Design", 
      alt: "Hand holding smartphone with search interface and digital elements"
    },
    {
      id: 3,
      image: "/theimpulsedigital.com/video  After about us section 800 x 530 3.jpg",
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] text-3xl md:text-4xl lg:text-5xl mb-8">
           Videos That Entertain and Convert 
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
           Are you a startup or an established brand? No matter your business’s stage and size, our flexible social media video 
           production services caters to all businesses alike. Our experts bring together the specific needs of all platforms, 
           the distinct audience preferences, and the best practices globally to create social media videos that don’t 
           just entertain but also convert your audience into customers.
          </p>
        </div>
