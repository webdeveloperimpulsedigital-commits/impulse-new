export const BrandVisionSection = (): JSX.Element => {
  const stats = [
    {
      percentage: "50%",
      description: "of video content achieves viral reach, significantly boosting client brand visibility."
    },
    {
      percentage: "4X", 
      description: "average conversion rate for clients using video content compared to static ads."
    },
    {
      percentage: "50%",
      description: "higher click-through rates (CTR) for video ads over traditional banner ads."
    }
  ];
  ...
  const services = [
    {
      ...
      description: "We develop storylines, formats, and hooks suited to each platform."
    },
    {
      title: "Production and Editing",
      description: "Filming, animation, and sound design bring the concept to life."
    },
    {
      title: "Optimization and Versioning",
      description: "Videos are adapted for reels, stories, and posts across platforms."
    },
    {
      title: "Publishing and Analysis",
      description: "Performance is tracked to refine creative direction for future content."
    }
  ];
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              <img
                src="/theimpulsedigital.com/video About service - 451 x 500.jpg"
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-[#f8f9fa] rounded-xl p-6 border-l-4 border-[#543d98]">
              <p className="[font-family:'DM_Sans',Helvetica] font-medium text-[#030019] text-base leading-relaxed">
                Go back to all the reels you have scrolled and YouTube videos you have watched on repeat. 
                What made you like them? Was it the visuals, the story, or the editing?
              </p>
            </div>
        ...
        <div className="text-center mb-12">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[#030019] text-base leading-relaxed max-w-4xl mx-auto">
            A successful social media profile knows how to grab attention and without good visuals, it is nearly impossible to 
            keep your audience engaged. At our social media video production company, we specialize in crafting high-quality,
             scroll-stopping social media videos for business. Whether you need instagram video production, facebook video production, 
             instagram videography, or youtube video production—our expert team delivers content that captivates
          </p>
        </div>
