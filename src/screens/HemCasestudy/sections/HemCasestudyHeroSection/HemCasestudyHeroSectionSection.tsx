...
export const HemCasestudyHeroSection = (): JSX.Element => {
  const heroTextLines = ["HEM"];

  return (
    <> 
      {/* ✅ SEO Meta Tags */}
    <Helmet>
        <title>Global SEO Strategy for HEM Incense | Impulse Digital Case Study</title>
        <meta name="description" content="Explore how Impulse Digital helped HEM Incense achieve 300% more first-page rankings and 5× organic traffic with technical SEO and multi-country websites." />
        ...
        {/* Open Graph Meta Tags */}
            <meta
              property="og:title"
              content="Global SEO Strategy for HEM Incense | Impulse Digital Case Study"
            />
            <meta
            ...
            <link rel="canonical" href="https://www.theimpulsedigital.com/casestudies/hem/" />
