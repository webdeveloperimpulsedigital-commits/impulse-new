        ...
        <div className="block lg:hidden space-y-10">
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/why chooose us section 576 x 400 2.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/why chooose us section 576 x 400 1.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[28px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/why choose us section 1202 x 400.jpg"
