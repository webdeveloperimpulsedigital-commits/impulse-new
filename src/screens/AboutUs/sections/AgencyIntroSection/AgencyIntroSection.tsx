...
export const AgencyIntroSection = (): JSX.Element => {
  return (
    <section className="w-full bg-white py-16 lg:py-28" id="abt-sec-border">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 space-y-14 lg:space-y-18">
        {/* HERO */}
        ...
        {/* BAND 1 */}
        <section className="rounded-[34px] border border-[#ece8ff] overflow-hidden shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
          <div className="grid lg:grid-cols-2">
            <div className="bg-white p-6 md:p-10 lg:p-14 space-y-4">
        ...
        {/* BAND 2 (inverted text area tone) */}
        <section className="rounded-[34px] border border-[#ece8ff] overflow-hidden shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
          <div className="grid lg:grid-cols-2">
            <div className="relative bg-slate-200 order-2 lg:order-1">
            ...
            <div className="bg-[#fbfaff] p-6 md:p-10 lg:p-14 space-y-5 order-1 lg:order-2">
              <h2 className="text-[#543d98] font-bold text-[22px] md:text-[34px] leading-[1.15]">
        ...
        <section className="rounded-[34px] border border-[#ece8ff] overflow-hidden shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-[#fbfaff] p-6 md:p-10 lg:p-14 space-y-4">
              <h2 className="text-[#543d98] font-bold text-[22px] md:text-[34px] leading-[1.15]">
