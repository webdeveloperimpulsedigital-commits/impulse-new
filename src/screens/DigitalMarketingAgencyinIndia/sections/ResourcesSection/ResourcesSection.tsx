    ...
    >
      <div className="wrap-res">
        ...
        <div className="resources-teaser__imageWrap">
          <img
            src="https://www.theimpulsedigital.com/rectangle-32.png" /* replace with your actual path */
        ...
        <div className="resources-teaser__content">
          ...
          <p className="pt-5 [font-family:'DM_Sans',Helvetica] text-[#ffffff] sm:text-[12px] md:text-[24px] lg:text-[20px] leading-relaxed text-left pb-8">
            We believe in the power of sharing knowledge. Browse our carefully curated collection of ebooks, videos, and presentations, each designed to offer valuable insights, improve your strategies, and help you achieve your business goals
          </p>
