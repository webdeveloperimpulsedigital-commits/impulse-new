...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    simple: {
      ...
      text: "SEO doesn’t need to feel confusing. As an SEO company in Sanpada, we focus on keeping things clear and practical. This helps you understand what’s happening without unnecessary complexity.",
    },
    dataDriven: {
    ...
    noFixed: {
      ...
      text: "The challenges vary from one business to another. We adjust the approach based on your goals instead of following a standard template.",
    },
    builtForChange: {
      title: "Built for Changing Search Behaviour",
      text: "Search keeps evolving, sometimes quietly. We keep refining strategies so your visibility stays stable and continues to improve.",
    }
  };
