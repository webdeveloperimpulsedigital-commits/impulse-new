...
export const ProcessSection = (): JSX.Element => {
  ...
  const processSteps: ProcessStep[] = [
    ...
    },
    {
      ...
      description: "We focus on real search behaviour, including terms like SEO company in Sanpada, but we don’t overuse them.",
      expandedContent: "We focus on real search behaviour, including terms like SEO company in Sanpada, but we don’t overuse them. The goal is to match intent rather than just repeat keywords.",
    },
    {
      id: 3,
      title: "Local SEO Improvements",
      description: "We help your business show up in searches happening around Sanpada.",
      expandedContent: "We help your business show up in searches happening around Sanpada. This increases the chances of attracting nearby customers.",
    },
    {
      id: 4,
