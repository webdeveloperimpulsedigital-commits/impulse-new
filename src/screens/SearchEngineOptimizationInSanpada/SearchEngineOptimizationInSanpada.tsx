...
export const SearchEngineOptimizationInSanpada = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-sanpada"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Sanpada" />
        <FooterSection />
      </div>
    </main>
  );
