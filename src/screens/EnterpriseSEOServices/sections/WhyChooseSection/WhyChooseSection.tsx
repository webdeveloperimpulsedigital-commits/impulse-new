        ...
        <div className="block lg:hidden space-y-10">
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/why-choose-1.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/Why Choose Enterprise-Increased Traffic.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[28px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/Why Choose Enterprise-Local and international.jpg"
