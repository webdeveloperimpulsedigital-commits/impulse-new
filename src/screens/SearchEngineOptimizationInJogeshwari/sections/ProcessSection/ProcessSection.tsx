...
export const ProcessSection = (): JSX.Element => {
  ...
  const processSteps: ProcessStep[] = [
    ...
    },
    {
      ...
      description:
        "We focus on real search behaviour, including terms like SEO agency in Jogeshwari, but we don’t force them everywhere. The goal is to match intent rather than just repeat keywords.",
      expandedContent:
        "We focus on real search behaviour, including terms like SEO agency in Jogeshwari, but we don’t force them everywhere. The goal is to match intent rather than just repeat keywords.",
    },
    {
      ...
      description:
        "We help your business show up in searches happening around Jogeshwari. This increases the chances of attracting nearby customers.",
      expandedContent:
        "We help your business show up in searches happening around Jogeshwari. This increases the chances of attracting nearby customers.",
    },
    {
