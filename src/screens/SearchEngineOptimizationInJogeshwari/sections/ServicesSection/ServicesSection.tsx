  ...
  const data = [
    {
      ...
      points: [
        "Search is slowly changing, and people are starting to rely more on AI tools to find answers. This shifts how content gets picked up and shown. We make sure your website content is structured in a way that works across both traditional search and newer platforms.",
      ],
      img: "/AI SEO.jpg",
    },
    {
      ...
      points: [
        "As websites grow, small issues tend to build up, like pages not indexed properly, the structure getting confusing, or links not working as expected. We help organize things so your website performs more consistently and doesn’t lose visibility.",
      ],
    ...
    },
    {
      ...
      points: [
        "For online businesses, visibility directly affects how many people actually find your products. If they don’t show up, they don’t get clicked. We work on improving how your products and categories appear in search results.",
      ],
    ...
    },
    {
      ...
      points: [
        "If your customers are around Jogeshwari, local searches become important. People nearby are usually closer to taking action. We help your business appear in those searches so you don’t miss out on relevant inquiries.",
      ],
    ...
    },
    {
      ...
      points: [
        "For service-based businesses, it’s not just about getting traffic; it’s about getting the right traffic. We focus on targeting searches that reflect real intent, so the leads you get are more meaningful.",
      ],
    ...
    },
    {
      ...
      points: [
        "If you have an app, visibility inside app stores matters just as much as website visibility. We improve how your app appears so more users can discover it.",
      ],
    ...
    },
    {
      ...
      points: [
        "If you’re planning to expand beyond your current market, your SEO setup needs to support that. We help structure your website so it can target different regions without confusion.",
      ],
...

    {
      ...
      points: [
        "Shopify websites sometimes need structural improvements to perform better in search. We work on optimizing your store so search engines can better understand and rank your products.",
      ],
    ...
    },
    {
      ...
      points: [
        "Getting traffic is just one part of the process. What users do after landing on your site matters more. We look at user behaviour and make changes that improve conversions over time.",
      ],
