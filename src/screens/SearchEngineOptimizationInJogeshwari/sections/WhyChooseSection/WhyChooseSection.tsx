...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "We rely on actual search trends, competitor insights, and user behaviour. This helps us focus on efforts that are more likely to deliver results.",
    },
    seoStrategies: {
      title: "No Fixed Strategy",
      text: "Each business is unique, with its own set of challenges. We adjust the approach based on your goals instead of following a standard template.",
    },
    transparent: {
      title: "Built for Changing Search Trends",
      text: "Search behaviour keeps evolving, sometimes quietly. If you don’t adapt, it can affect visibility over time. We keep refining strategies so your rankings stay stable and continue improving.",
    }
  };
