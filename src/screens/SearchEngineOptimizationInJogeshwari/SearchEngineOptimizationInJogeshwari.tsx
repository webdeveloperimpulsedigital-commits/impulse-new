...
export const SearchEngineOptimizationInJogeshwari = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-jogeshwari"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Jogeshwari" />
        <FooterSection />
      </div>
    </main>
  );
