...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN GHATKOPAR"];
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="seo company in ghatkopar" />
        ...
        <meta property="og:title" content="SEO Company in Ghatkopar | SEO Services | Impulse Digital" />
        <meta property="og:description" content="Work with Impulse Digital, an SEO company in Ghatkopar, to improve your website rankings, strengthen search presence and reach customers actively looking for your services." />
        ...
        <meta name="twitter:title" content="SEO Company in Ghatkopar | SEO Services | Impulse Digital" />
        <meta name="twitter:description" content="Work with Impulse Digital, an SEO company in Ghatkopar, to improve your website rankings, strengthen search presence and reach customers actively looking for your services." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/ghatkopar/" />
