...
import { Fourse4goodCaseStudyHeroSection } from "./sections/Fourse4goodCaseStudyHeroSection/Fourse4goodCaseStudyHeroSection";
...
export const Fourse4goodCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <Fourse4goodCaseStudyHeroSection />
        <BrandVisionSection />
