...
export const SearchEngineOptimizationInPanvel = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-panvel"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Panvel" />
        <FooterSection />
      </div>
    </main>
  );
