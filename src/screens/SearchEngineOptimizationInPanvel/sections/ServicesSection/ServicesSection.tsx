  ...
  const data = [
    {
      ...
      points: [
        "Search is gradually evolving, and more users are turning to AI tools to find quick answers. This changes how content gets discovered and presented. We structure your website content so it works across both traditional search engines and newer AI-driven platforms.",
      ],
      img: "/ai_seo_v3.png",
    },
    {
      ...
      points: [
        "As websites grow, small issues can start affecting performance, things like indexing gaps or unclear structure. We help organize and fix these issues so your website performs more smoothly and doesn’t lose visibility.",
      ],
    ...
    },
    {
      ...
      points: [
        "For online stores, visibility directly impacts how many people even find your products. If they don’t see you, they won’t click. We focus on improving how your products and categories appear so they’re easier to discover.",
      ],
    ...
    },
    {
      ...
      points: [
        "If your customers are around Panvel, local searches matter a lot. People nearby are usually closer to taking action. We help your business appear in those searches so you don’t miss out on relevant local inquiries.",
      ],
    ...
    },
    {
      ...
      points: [
        "For service-based businesses, it’s not just about getting traffic; it’s about getting the right traffic. We focus on targeting searches that show intent, so the leads you get are more meaningful.",
      ],
