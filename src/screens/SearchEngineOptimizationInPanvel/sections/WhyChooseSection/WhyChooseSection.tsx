...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    simple: {
      ...
      text: "SEO doesn’t need to feel confusing. As an SEO company in Panvel, we focus on keeping things clear and practical. This helps you understand what’s happening without unnecessary complexity.",
    },
    dataDriven: {
    ...
    noFixed: {
      ...
      text: "Every business is different, and so are its challenges. We adjust the approach based on your goals instead of following a standard template.",
    },
    builtForChange: {
