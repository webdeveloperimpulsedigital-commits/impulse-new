      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="mb-6 lg:mb-8 pt-0">
          ...
          <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#543d98] lg:text-[52px] sm:text-[26px] leading-tight ">
             Impulse Digital’s Corporate Communication Services?
          </h2>
        </div>
        ...
        <div className="block lg:hidden space-y-10">
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/corporate why chooose us section 576 x 400 1.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/corporate why chooose us section 576 x 400 2.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[28px] shadow-lg mb-4">
              <img
                src="/theimpulsedigital.com/corporate why choose us section 1202 x 400.jpg"
