...
export const AtracEnginePartsCaseStudyHeroSection = (): JSX.Element => {
  const heroTextLines = ["Atrac"];

  return (
    <> 
      {/* ✅ SEO Meta Tags */}
    <Helmet>
        <title>Atrac Engine Parts Social Media Success | Impulse Digital Case Study</title>
        <meta name="description" content="See how Impulse Digital helped Atrac Engine Parts reposition as a manufacturer on LinkedIn, achieving 11K+ impressions and an 8.3% engagement rate." />
        ...
        {/* Open Graph Meta Tags */}
            <meta
              property="og:title"
              content="Atrac Engine Parts Social Media Success | Impulse Digital Case Study"
            />
            <meta
            ...
            <link rel="canonical" href="https://www.theimpulsedigital.com/casestudies/atrac-engine-parts/" />
      ...
      >
        ...
        <nav className="flex items-center justify-center gap-2 text-white/80 text-sm">
          ...
          <span className="text-white">Case Studies</span>
            <span className="select-none">{">"}</span>
          <span className="text-white">Atrac</span>
        </nav>
            </div>
          </div>
        </header>
