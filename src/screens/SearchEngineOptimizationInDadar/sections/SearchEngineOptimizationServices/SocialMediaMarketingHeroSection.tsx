...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN DADAR"];
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="seo company in dadar; seo agency in dadar" />
        ...
        <meta property="og:title" content="SEO Company in Dadar | SEO Agency | Impulse Digital" />
        <meta property="og:description" content="Impulse Digital is an SEO company in Dadar helping brands improve search visibility through keyword research, website optimisation, content strategy and performance-focused SEO." />
        ...
        <meta name="twitter:title" content="SEO Company in Dadar | SEO Agency | Impulse Digital" />
        <meta name="twitter:description" content="Impulse Digital is an SEO company in Dadar helping brands improve search visibility through keyword research, website optimisation, content strategy and performance-focused SEO." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/dadar/" />
