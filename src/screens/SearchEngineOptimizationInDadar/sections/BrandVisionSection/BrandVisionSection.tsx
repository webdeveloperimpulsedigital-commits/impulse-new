    ...
    >
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          ...
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">As an SEO company in Dadar, we focus on helping businesses become visible where it actually matters. Not just for rankings, but for getting real inquiries and consistent traction over time.</p>
        </div>
