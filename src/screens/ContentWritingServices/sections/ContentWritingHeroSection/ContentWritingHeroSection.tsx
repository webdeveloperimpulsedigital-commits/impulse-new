...
<meta name="twitter:image" content="https://www.theimpulsedigital.com/services/content-writing-services"/>
<meta name="twitter:url" content="https://www.theimpulsedigital.com/services/content-writing-services"/>
        ...
        <header>
          ...
          <div className="absolute inset-0 w-full h-[598px] sm:h-[698px] md:h-[798px] lg:h-[818px] bg-[url(/rectangle-35.png)] bg-cover bg-center">
            ...
            <div className="absolute inset-0 z-0">
              ...
              >
                <source src="/content-wrrting-video.mp4" type="video/mp4" />
              </video>
              {/* Dark overlay */}
              <div
