  ...
  const processSteps: ProcessStep[] = [
    {
      ...
      expandedContent:
        "Our audit reveals technical gaps, content issues, and areas where search engines struggle to understand your site. We diagnose what’s holding you back.",
    },
    {
      id: 2,
      title: "Keyword Research",
      description:
        "We focus on real search behaviour, including terms like SEO company in Mansarovar, but we don’t overuse them. The goal is to match intent rather than just repeat keywords.",
      expandedContent:
        "We identify keywords that real users are typing—not just generic terms. The focus is on capturing local intent while keeping the content natural and user-focused.",
    },
    {
      id: 3,
      title: "Local SEO Improvements",
      description:
        "We help your business show up in searches happening around Mansarovar. This increases the chances of attracting nearby customers.",
      expandedContent:
    ...
    },
    {
      ...
      expandedContent:
        "We fix technical issues like page speed, indexing, and site structure to ensure search engines can crawl and understand your site without any issues.",
    },
    {
      id: 5,
      title: "Content Work",
