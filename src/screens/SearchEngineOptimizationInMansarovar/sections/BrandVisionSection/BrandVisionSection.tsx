    ...
    >
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          ...
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            So if your business isn’t visible at that stage, you could be missing out on potential customers. As an SEO company in Mansarovar, we focus on helping businesses build consistent visibility,
            something that works steadily over time, not just in short bursts.
          </p>
        </div>
