  ...
  const data = [
    {
      ...
      points: [
        "Search is gradually evolving, and more users are turning to AI tools for quick answers. This changes how content gets discovered and presented. We structure your website content so it works across both search engines and AI-driven platforms.",
      ],
      img: "/AI SEO.jpg",
    },
    {
      ...
      points: [
        "As websites grow, small issues can start affecting performance - things like indexing gaps or unclear structure. We help organize and fix these issues so your website runs more smoothly and doesn’t lose visibility.",
      ],
    ...
    },
    {
      ...
      points: [
        "If your customers are around Mansarovar, local searches become important. People nearby are usually closer to taking action. We help your business appear in those searches so you don’t miss out on relevant local inquiries.",
      ],
    ...
    },
    {
      ...
      points: [
        "For service-based businesses, it’s not just about traffic, but it’s about getting the right traffic. We focus on targeting searches that show intent, so the leads you get are more meaningful.",
      ],
