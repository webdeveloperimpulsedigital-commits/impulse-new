...
export const SearchEngineOptimizationInMansarovar = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-mansarovar"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Mansarovar" />
        <FooterSection />
      </div>
    </main>
  );
