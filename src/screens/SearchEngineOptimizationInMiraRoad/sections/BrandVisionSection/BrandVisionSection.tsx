    ...
    >
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          ...
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]"> That’s why visibility matters more than ever. As an SEO company in Mira Road, we focus on helping businesses show up consistently, not just once, but over time in a way that actually brings inquiries.</p>
        </div>
