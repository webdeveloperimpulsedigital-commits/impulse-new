...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "We rely on actual search trends, competitor insights, and user behaviour. This way, efforts go into things that have a real chance of working.",
    },
    seoStrategies: {
      title: "No One-Size-Fits-All Strategy",
      text: "Every business is different. An approach that works for one may not be effective for another. We adjust the approach based on your goals and current situation.",
    },
    transparent: {
      title: "Built for Changing Search Behaviour",
      text: "Search keeps evolving, sometimes subtly. If you don’t adapt, it can affect visibility over time. We keep refining strategies so your rankings stay stable and continue improving.",
    }
  };
