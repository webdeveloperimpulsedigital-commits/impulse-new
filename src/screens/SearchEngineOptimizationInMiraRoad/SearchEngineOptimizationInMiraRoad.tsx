...
export const SearchEngineOptimizationInMiraRoad = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-mira-road"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Mira Road" />
        <FooterSection />
      </div>
    </main>
  );
