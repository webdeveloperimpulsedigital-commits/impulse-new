...
export const SearchEngineOptimizationInBorivali = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-borivali"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Borivali" />
        <FooterSection />
      </div>
    </main>
  );
