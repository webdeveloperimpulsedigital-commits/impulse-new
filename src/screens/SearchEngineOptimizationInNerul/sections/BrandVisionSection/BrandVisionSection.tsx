      ...
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            If you’re running a business in Nerul, you’ve probably noticed how much people rely on search before making a decision. Whether it’s finding a service or comparing options, most of it starts online now. And usually, people don’t spend too much time exploring. They go with what shows up early and feels relevant.
          </p>
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
