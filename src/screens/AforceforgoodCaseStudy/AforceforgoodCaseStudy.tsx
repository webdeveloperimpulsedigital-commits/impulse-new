...
import { AforceforgoodCaseStudyHeroSection } from "./sections/AforceforgoodCaseStudyHeroSection/AforceforgoodCaseStudyHeroSection";
...
export const AforceforgoodCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <AforceforgoodCaseStudyHeroSection />
        <BrandVisionSection />
