...
import { RainbowInternationalSchoolHeroSection } from "./sections/RainbowInternationalSchoolHeroSection/RainbowInternationalSchoolHeroSection";
...
export const RainbowInternationalSchoolCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <RainbowInternationalSchoolHeroSection />
        <BrandVisionSection />
