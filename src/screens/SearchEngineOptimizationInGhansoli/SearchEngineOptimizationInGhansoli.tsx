...
export const SearchEngineOptimizationInGhansoli = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-ghansoli"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Ghansoli" />
        <FooterSection />
      </div>
    </main>
  );
