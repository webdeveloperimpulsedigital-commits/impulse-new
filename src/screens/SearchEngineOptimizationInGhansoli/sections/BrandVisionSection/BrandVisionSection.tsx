      ...
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            If you’re running a business in Ghansoli, you’ve probably noticed how much people rely on search before making any decision. Whether it’s finding a service or comparing options, most of it starts online now.
          </p>
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            And usually, people don’t spend too much time exploring. They click on what shows up early and feels relevant.
          </p>
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            That’s where SEO starts to matter more than it seems. As an SEO agency in Ghansoli, we focus on helping businesses show up consistently, not just once, but in a way that keeps bringing the right kind of visibility.
          </p>
        </div>
