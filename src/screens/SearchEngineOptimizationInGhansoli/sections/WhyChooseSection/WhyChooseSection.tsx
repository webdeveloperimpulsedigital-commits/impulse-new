...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "We rely on actual search trends, competitor insights, and user behaviour. This ensures the work being done is focused on what can actually deliver results.",
    },
    seoStrategies: {
      title: "No Fixed Strategy",
      text: "No two businesses face the same challenges. We adjust the approach based on your goals instead of following a standard template.",
    },
    transparent: {
      title: "Built for Changing Search Behaviour",
      text: "Search keeps evolving, sometimes without obvious signs. We keep refining strategies so your visibility stays stable and continues to improve.",
    }
  };
