...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      title: "Decisions Based on Real Insights",
      text: "We don’t rely on assumptions. Everything is based on what people are searching for and how your competitors are performing. This helps us focus on opportunities that are actually worth pursuing.",
    },
    seoStrategies: {
      title: "No Copy-Paste Strategies",
      text: "Every business is at a different stage, so applying the same strategy everywhere doesn’t really work. We adjust our approach based on what your business actually needs.",
    },
    transparent: {
      title: "Built for Changing Search Trends",
      text: "Search behaviour keeps changing, sometimes faster than expected. What was effective a year ago doesn’t always hold up today. We keep refining strategies so your visibility doesn’t drop over time.",
    }
  };
