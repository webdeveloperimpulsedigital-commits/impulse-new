        ...
        <div className="block lg:hidden space-y-10">
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/focus-on-digital-camera-near-talented-asian-stylis-2024-11-11-11-37-59-utc.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[24px] shadow-lg mb-4">
              <img
                src="/business-technology-and-people-concept-close-up-2025-10-03-15-53-55-utc.jpg"
          ...
          <div>
            <div className="relative overflow-hidden rounded-[28px] shadow-lg mb-4">
              <img
                src="/video  why chooose us section 576 x 400 3.jpg"
