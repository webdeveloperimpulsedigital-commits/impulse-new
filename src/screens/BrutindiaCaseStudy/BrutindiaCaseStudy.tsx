...
import { BrutindiaCaseStudyHeroSection } from "./sections/BrutindiaCaseStudyHeroSection/BrutindiaCaseStudyHeroSection";
...
export const BrutindiaCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <BrutindiaCaseStudyHeroSection />
        <BrandVisionSection />
