...
export const BrutindiaCaseStudyHeroSection = (): JSX.Element => {
  return (
    <>
    <Helmet>
    ...
    <meta name="twitter:url" content="https://www.theimpulsedigital.com/casestudies/brutindia/" />
        ...
        <nav className="flex items-center justify-center gap-2 text-white/80 text-sm">
          ...
          <span className="select-none">{">"}</span>
           <span className="text-white">Case Studies</span>
            <span className="select-none">{">"}</span>
          <span className="text-white">Brut India</span>
        </nav>
      </div>
    </section>
    </>
