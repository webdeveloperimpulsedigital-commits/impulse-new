...
export const DmartHeroSection = (): JSX.Element => {
  const heroTextLines = ["DMArt"];
    ...
    <> 
     ...
     <Helmet>
        ...
        {/* Open Graph Meta Tags */}
            <meta
              property="og:title"
              content="DMart Digital Campaign Case Study | Driving Store Footfall with Social Media"
            />
            <meta
        ...
        <nav className="flex items-center justify-center gap-2 text-white/80 text-sm">
          ...
          <span className="select-none">{">"}</span>
           <span className="text-white">Case Studies</span>
            <span className="select-none">{">"}</span>
          <span className="text-white">Dmart</span>
        </nav>
            </div>
          </div>
        </header>
