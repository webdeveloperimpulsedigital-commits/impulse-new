...
import { AIVideoProductionServicesHeroSection } from "./sections/AIVideoProductionServicesHeroSection/AIVideoProductionServicesHeroSection";
...
export const AIVideoProductionServices = (): JSX.Element => {
    const faqs = faqData["/services/video-production/ai-video-production"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        <AIVideoProductionServicesHeroSection />
        <BrandVisionSection />
