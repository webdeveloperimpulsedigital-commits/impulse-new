...
export const SearchEngineOptimizationInTurbhe = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-turbhe"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Turbhe" />
        <FooterSection />
      </div>
    </main>
  );
