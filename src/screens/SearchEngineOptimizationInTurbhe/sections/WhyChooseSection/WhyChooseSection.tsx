...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    simple: {
      ...
      text: "SEO doesn’t need to feel confusing. As an SEO company in Turbhe, we focus on keeping things clear and practical. This helps you understand what’s happening without unnecessary complexity.",
    },
    dataDriven: {
    ...
    noFixed: {
      ...
      text: "Every business operates differently, and so do the challenges it encounters. We adjust the approach based on your goals instead of following a standard template.",
    },
    builtForChange: {
