...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "Every campaign is backed by keyword research, competitor insights, and performance analytics.",
    },
    seoStrategies: {
      title: "Customized SEO Strategies",
      text: "We don’t use templates. Each SEO plan is built based on your business goals, industry competition, and audience behaviour.",
    },
    transparent: {
      title: "Optimized for Modern Search",
      text: "Search is evolving with AI and voice. Our strategies ensure your business stays visible across both traditional and emerging platforms.",
    }
  };
