...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN NAVI MUMBAI"];
  ...
  return (
    <>
      {/* ✅ SEO Meta Tags */}
      <Helmet>
        <meta name="description" content="Looking for an SEO company in Navi Mumbai? Impulse Digital offers SEO services with smart strategies, keyword planning and performance-focused optimisation to help your business grow online." />
        <meta name="keywords" content="seo company in navi mumbai; seo agency in navi mumbai; seo services in navi mumbai" />
        <title>SEO Company in Navi Mumbai | SEO Agency | Impulse Digital</title>
        ...
        <meta property="og:title" content="SEO Company in Navi Mumbai | SEO Agency | Impulse Digital" />
        <meta property="og:description" content="Looking for an SEO company in Navi Mumbai? Impulse Digital offers SEO services with smart strategies, keyword planning and performance-focused optimisation to help your business grow online." />
        ...
        <meta name="twitter:title" content="SEO Company in Navi Mumbai | SEO Agency | Impulse Digital" />
        <meta name="twitter:description" content="Looking for an SEO company in Navi Mumbai? Impulse Digital offers SEO services with smart strategies, keyword planning and performance-focused optimisation to help your business grow online." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/navi-mumbai/" />
