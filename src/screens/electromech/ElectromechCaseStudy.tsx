...
import { ElectromechCaseStudyHeroSection } from "./sections/ElectromechCaseStudyHeroSection";
...
export const ElectromechCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <ElectromechCaseStudyHeroSection />
        <BrandVisionSection />
