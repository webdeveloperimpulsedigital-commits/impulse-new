...
export const ElectromechCaseStudyHeroSection = (): JSX.Element => {
  const heroTextLines = ["electromech"];
  ...
  return (
    ...
    {/* Open Graph Meta Tags */}
        <meta
          property="og:title"
          content="ElectroMech Digital Transformation Case Study | 20× Lead Growth"
        />
        <meta
         ...
         <nav className="flex items-center justify-center gap-2 text-white/80 text-sm">
          ...
          <span className="select-none">{">"}</span>
           <span className="text-white">Case Studies</span>
            <span className="select-none">{">"}</span>
          <span className="text-white">Electromech</span>
        </nav>
            </div>
          </div>
        </header>
