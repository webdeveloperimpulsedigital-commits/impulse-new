...
export const SearchEngineOptimizationInKoparkhairane = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-Koparkhairane"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Koparkhairane" />
        <FooterSection />
      </div>
    </main>
  );
