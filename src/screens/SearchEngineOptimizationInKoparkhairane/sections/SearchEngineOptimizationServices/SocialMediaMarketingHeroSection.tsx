...
export const SocialMediaMarketingHeroSection = (): JSX.Element => {
  const heroTextLines = ["SEO AGENCY IN KOPARKHAIRANE"];
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="seo company in koparkhairane" />
        ...
        <meta property="og:title" content="SEO Company in Koparkhairane | SEO Services | Impulse Digital" />
        <meta property="og:description" content="Impulse Digital is an SEO company in Koparkhairane helping businesses grow online with website optimisation, keyword strategy, content planning and search visibility solutions." />
        ...
        <meta name="twitter:title" content="SEO Company in Koparkhairane | SEO Services | Impulse Digital" />
        <meta name="twitter:description" content="Impulse Digital is an SEO company in Koparkhairane helping businesses grow online with website optimisation, keyword strategy, content planning and search visibility solutions." />
        <meta name="twitter:image" content="https://www.theimpulsedigital.com/img/logo-id-new.jpg" />
        <meta name="twitter:url" content="https://www.theimpulsedigital.com/services/search-engine-optimization/" />
        <link rel="canonical" href="https://www.theimpulsedigital.com/services/search-engine-optimization/koparkhairane/" />
