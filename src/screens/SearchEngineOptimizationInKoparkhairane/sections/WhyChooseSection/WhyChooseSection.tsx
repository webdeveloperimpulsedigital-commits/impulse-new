...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "We rely on actual search trends, competitor insights, and user behaviour. This ensures that efforts are focused on what can actually deliver results.",
    },
    seoStrategies: {
      title: "No Fixed Strategy",
      text: "The challenges vary from one business to another. We adjust the approach based on your goals instead of using a standard template.",
    },
    transparent: {
      title: "Built for Changing Search Behaviour",
      text: "Search behaviour keeps evolving over time. We keep refining strategies so your visibility stays stable and continues to improve.",
    }
  };
