    ...
    >
      <div className="max-w-[1280px] mx-auto px-2 lg:px-5 sm:py-10">
        ...
        <div className="text-left mb-12">
          ...
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            And most of the time, they don’t scroll too far.
          </p>
          <p className="[font-family:'DM_Sans',Helvetica] font-normal text-[12px] lg:text-[24px] text-[#030019]">
            So if your business isn’t visible at that moment, you’re likely missing out on potential inquiries. As an SEO agency in Airoli, we focus on helping businesses show up consistently, not just for a short period but in a way that builds over time.
          </p>
        </div>
