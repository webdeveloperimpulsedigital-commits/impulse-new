...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    ...
    seoStrategies: {
      ...
      text: "Every business is unique, with its own set of challenges. We adjust the approach based on your goals instead of following a fixed template.",
    },
    transparent: {
      title: "Built for Changing Search Behaviour",
      text: "Search keeps evolving, sometimes quietly. We keep refining strategies so your visibility stays consistent and continues to improve.",
    }
  };
