...
export const SearchEngineOptimizationInAiroli = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-airoli"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Airoli" />
        <FooterSection />
      </div>
    </main>
  );
