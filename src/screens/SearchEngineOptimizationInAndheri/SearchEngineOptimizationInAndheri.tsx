...
export const SearchEngineOptimizationInAndheri = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-andheri"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Andheri" />
        <FooterSection />
      </div>
    </main>
  );
