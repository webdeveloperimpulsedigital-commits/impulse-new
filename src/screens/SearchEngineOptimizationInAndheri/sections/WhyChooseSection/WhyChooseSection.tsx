...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      title: "We Don’t Overcomplicate SEO",
      text: "SEO can get confusing quickly. As an SEO company in Andheri, we try to keep things simple and focused on what actually works.",
    },
    seoStrategies: {
      title: "No Copy-Paste Strategies",
      text: "Every business is different. What works for one may not work for another, so we don’t follow fixed templates.",
    },
    transparent: {
      title: "Built for Changing Search Behaviour",
      text: "Search is evolving, and we adjust strategies accordingly instead of sticking to outdated methods.",
    }
  };
