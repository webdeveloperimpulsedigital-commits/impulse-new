...
export const SearchEngineOptimizationInKandivali = (): JSX.Element => {
  const faqs = faqData["/services/search-engine-optimization-in-kandivali"] || [];
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        ...
        <LocationSelectorSection currentLocation="Kandivali" />
        <FooterSection />
      </div>
    </main>
  );
