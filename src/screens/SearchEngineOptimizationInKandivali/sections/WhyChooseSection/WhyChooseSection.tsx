...
export const WhyChooseSection = (): JSX.Element => {
  ...
  const content = {
    dataDriven: {
      ...
      text: "We look at what people are searching for, what your competitors are doing, and where the gaps are, then build from there.",
    },
    seoStrategies: {
      title: "No One-Size-Fits-All Approach",
      text: "What works for one business might not work for another. So we don’t copy-paste strategies.",
    },
    transparent: {
      title: "Built for How People Search Today",
      text: "Search behaviour keeps changing. We make sure your website keeps up, whether it’s Google or newer platforms.",
    }
  };
